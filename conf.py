...
BLOG_AUTHOR = "Aurelien Naldi"  # (translatable)
BLOG_TITLE = "Recettes en vrac"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "http://aurelien.naldi.info/perso/cookbook/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://cuisine.naldi.info/"
BLOG_EMAIL = "aurelien.naldi@gmail.com"
BLOG_DESCRIPTION = "quelques recettes en vrac"  # (translatable)
...
POSTS = (
    ("posts/desserts/*.rst", "desserts", "post.tmpl"),
    ("posts/meals/*.rst", "meals", "post.tmpl"),
)
PAGES = (
...
# Tag pages will still be generated.
HIDDEN_AUTHORS = ['Aurelien Naldi', 'Guest']
